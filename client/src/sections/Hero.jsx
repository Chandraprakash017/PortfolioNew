        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <img 
              src="/raja.jpeg" 
              alt="Profile Photo" 
              className="w-48 h-48 rounded-full object-cover object-top mx-auto mb-8 shadow-2xl border-4 border-white/20 dark:border-dark-border/50 scale-125 hover:scale-110 transition-transform duration-500"
            />
